...
A Terraform module which deploys the Snowplow Stream Collector on CE.  If you want to use a custom AMI for this deployment you will need to ensure it is based on top of Ubuntu 20.04.
